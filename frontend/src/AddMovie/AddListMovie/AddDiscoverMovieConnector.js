...
import { fetchDiscoverMovies, clearListMovie, setListMovieSort, setListMovieFilter, setListMovieView, setListMovieTableOption } from 'Store/Actions/addListMovieActions';
...
function createMapStateToProps() {
  return createSelector(
    createAddMovieClientSideCollectionItemsSelector('addListMovie'),
